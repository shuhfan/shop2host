...
user_router.get('/liteplan',userController.loadLitePlan)
user_router.get('/heroplan',userController.loadHeroPlan)
user_router.get('/proplan',userController.loadProPlan)
