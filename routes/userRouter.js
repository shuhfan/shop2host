...
user_router.post('/create-store',userController.createStore)
user_router.post('/store-details',  upload.single('logo'),userController.storeDetails)
user_router.post('/find-domain',userController.findDomain)
